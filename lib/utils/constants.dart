...
class AppConstants {
  ...
  static const List<String> examCategories = [
    'Public Health', 'Water Quality', 'Food Safety', 'Environmental Health',
    'Sanitation', 'Disease Control', 'Health Laws', 'General Science',
  ];
  ...
  // Feature Flags
  static const bool enableLiveTest = false;
